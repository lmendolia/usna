 ...
 * Resources: MGSP, EI, class notes, Dylan Struthers, and Katie Swafford
 used the following reference for futimens syntax:
 https://books.google.com/books?id=kCTMFpEcIOwC&pg=PA127&lpg=PA127&dq=futimens+example&source=bl&ots=zvIBYJTxrJ&sig=zZ40XVrSVlnYEQZf5GnpRjIZrxg&hl=en&sa=X&ved=0ahUKEwiyw52W8ZvLAhXKpx4KHa2kAooQ6AEISzAI#v=onepage&q=futimens%20example&f=false
 */
// Required Includes
